...
ENV PATH /opt/conda/envs/nf-core-diaproteomics-1.2.3dev/bin:$PATH

# Dump the details of the installed packages to a file for posterity
RUN conda env export --name nf-core-diaproteomics-1.2.3dev > nf-core-diaproteomics-1.2.3dev.yml
