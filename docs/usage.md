...
```bash
nextflow run nf-core/diaproteomics --reads '*_R{1,2}.fastq.gz' -profile docker
```
...
* `docker`
  ...
  * Pulls software from dockerhub: [`nfcore/diaproteomics`](http://hub.docker.com/r/nfcore/diaproteomics/)
* `singularity`
